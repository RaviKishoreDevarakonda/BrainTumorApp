...
import 'dart:io';
import 'package:http/http.dart' as http;import 'package:flutter/services.dart' show rootBundle;
      ...
      children: <Widget>[
        ...
        _image != null
          ...
          children: [
            ...
            _imageValue != null
                ? TextFormField(
              key: ValueKey(_image), // Add a unique key for the TextFormField
              ...
              style: TextStyle( // Added style for the text form field
...
class _MyHomeState extends State<MyHome> {
  ...
  bool _isPredictionMade = false; // Added variable to track if prediction has been made
  String? _videoName; // Added variable to store the video file name

  void _handleImageSelected(File? image) {
    setState(() {
      _selectedImage = File(image!.path);
      _videoName = _selectedImage != null ? _selectedImage!.path.split('/').last : null; // Get the video file name
      _textFieldController.text = '';
      _isPredictionMade = false; // Reset the prediction state when a new image is selected
    });
  }
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: _isPredictButtonDisabled ? null : () async {
                    if (_selectedImage != null) {
                      ...
                      var request = http.MultipartRequest(
                        'POST',
                        Uri.parse('http://54.252.215.122/ipredict'),
                      );
                      ...
                      if (response.statusCode == 200) {
                        ...
                        setState(() {
                          ...
                          _isPredictionMade = true; // Set the prediction state to true
                        });
                        print(jsonResponse);
                      } else {
                ...
                SizedBox(height: 20),
                if (_isPredictionMade && _videoName != null) // Show the TextFormField only if a video is selected and prediction has been made
                  Center(
                    child: Padding(
