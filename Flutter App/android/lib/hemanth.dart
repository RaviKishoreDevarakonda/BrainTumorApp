  ...
  Future<void> predictVideo() async {
    if (_selectedVideo != null) {
      ...
      try {
        ...
        var result = 'Yes';
        _prediction = result;
        final ref = storage.ref().child('videos/output1.mp4');
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.fromLTRB(20, 15, 20, 15),
                                  labelText:
                                      'AI Prediction Number of Normal Frames',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(10),
                                  ),
                                ),
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.fromLTRB(20, 15, 20, 15),
                                  labelText:
                                      'AI Prediction Number of Abnormal Frames',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(10),
                                  ),
                                ),
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.fromLTRB(20, 15, 20, 15),
                                  labelText:
                                      'AI Prediction Total Number of Frames',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(10),
                                  ),
                                ),
